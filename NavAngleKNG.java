  ...
  public static void main(String args[]) {
	  ...
	  RXTXRobot r = new ArduinoNano(); // Create RXTXRobot object
		...
		r.refreshDigitalPins(); // Cache the analog pin information
			...
			double angleNK = 0;
			angleNK = Math.abs(averageN - averageK);
			System.out.println("The angle between N and K is " + angleNK);
...
// The two beacon angle differences can be set and the solver run any number of times
    nav.setAngles(angleGN,angleNK); // input the angles OneIR method receives
